...
import com.example.cabina10.latinoapp.fragment.AboutUsFragment;
import com.example.cabina10.latinoapp.fragment.StudentsFragment;
...
public class MenuActivity extends AppCompatActivity
    ...
    public void fragmentChange(String _fragment) {
        if (_fragment.equals("student-list")) {
            getFragmentManager().beginTransaction().
                      replace(R.id.mainFragment, new StudentsFragment())
